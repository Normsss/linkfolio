...
document.getElementById("answer").innerHTML = `Tu positive vibritation tiene los siguientes elementos: FECHA MÁGICA: ${randomIndex(specialDay)}. RETO DEL DÍA: ${randomIndex(dailyChallenge)}. y aquí tu  <a href="${randomIndex(song)}"> amuleto musical </a>`;
